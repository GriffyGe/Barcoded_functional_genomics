...
library(tidyverse)
readId_barcodes <- read_delim("Example_file/1.2_Get_barcode_gdna/table_id_bc.txt",
                              delim = "\t",
                              col_names = c("qseqid", "barcode"))
gdna_gene_info <- read_delim("Example_file/1.4_Select_best_hit_match_gene_info/best_hit_match_gene_res.txt", 
...
write_delim(result,"Example_file/1.5_Match_unique_inserted_gene/barcode_with_unique_gene.txt")
...
export(result_not_unique,"Example_file/1.5_Match_unique_inserted_gene/barcode_with_not_unique_gene.xlsx")
...
data <- import("Example_file/1.5_Match_unique_inserted_gene/barcode_with_not_unique_gene.xlsx")
gene_dict <- list()
...
not_unique_data <- import("Example_file/1.5_Match_unique_inserted_gene/barcode_with_not_unique_gene.xlsx",sheet=2)
...
unique_data <- read_delim("Example_file/1.5_Match_unique_inserted_gene/barcode_with_unique_gene.txt")
final_unique_data <- rbind(unique_data, usable_result)
write_delim(final_unique_data,"Example_file/1.5_Match_unique_inserted_gene/final_unique_barcode_and_gene.txt")

# 3. Select central insertions (10%~90%)====
result <- import("Example_file/1.5_Match_unique_inserted_gene/final_unique_barcode_and_gene.txt") 
...
export(result2,"Example_file/1.5_Match_unique_inserted_gene/final_unique_in_central_barcode.xlsx")